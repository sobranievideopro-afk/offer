...
ВАЖНО: комментарии к каждому критерию — максимум 1 короткое предложение (не более 20 слов). Это ограничение по формату, не экономь на сути анализа, но пиши предельно сжато.
...
async function analyzeResume(resumeText, targetRole = null) {
  ...
  return askClaudeJSON(SYSTEM_PROMPT, userMessage, 4000);
}
